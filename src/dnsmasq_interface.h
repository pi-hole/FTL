...
#define FTL_make_answer(header, n) _FTL_make_answer(header, n, __FILE__, __LINE__)
size_t _FTL_make_answer(struct dns_header *header, const size_t n, const char* file, const int line);

...
static void initConfig(struct config *conf)
{
	...
	conf->dhcp.start.a = cJSON_CreateStringReference("valid IPv4 address, or empty string (\"\")");
	...
	conf->dhcp.end.a = cJSON_CreateStringReference("valid IPv4 address, or empty string (\"\")");
	...
	conf->dhcp.router.a = cJSON_CreateStringReference("valid IPv4 address, or empty string (\"\")");
	...
	conf->ntp.sync.rtc.device.a = cJSON_CreateStringReference("valid RTC device path, or empty string (\"\") for auto-discovery");

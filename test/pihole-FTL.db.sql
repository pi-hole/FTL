...
CREATE TABLE IF NOT EXISTS "network" ( id INTEGER PRIMARY KEY NOT NULL, hwaddr TEXT UNIQUE NOT NULL, interface TEXT NOT NULL, firstSeen INTEGER NOT NULL, lastQuery INTEGER NOT NULL, numQueries INTEGER NOT NULL, macVendor TEXT);
...
INSERT INTO "network" (id, hwaddr, interface, firstSeen, lastQuery, numQueries) VALUES (1, '00:11:22:33:44:55', 'enp0s123', 0, 0, 0);

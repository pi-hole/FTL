...
@test "Get all queries shows expected content" {
  ...
  [[ ${lines[8]} == *"A regex5.test.pi-hole.net 127.0.0.1 4 2 4"* ]]
  ...
  [[ ${lines[12]} == *"A whitelisted.test.pi-hole.net 127.0.0.2 1 2 4"* ]]
  [[ ${lines[13]} == *"A regex1.test.pi-hole.net 127.0.0.2 4 2 4"* ]]
  [[ ${lines[14]} == *"A regex1.test.pi-hole.net 127.0.0.1 3 2 4"* ]]
  [[ ${lines[15]} == *"A regex1.test.pi-hole.net 127.0.0.3 3 2 4"* ]]
  [[ ${lines[16]} == *"A blacklist-blocked.test.pi-hole.net 127.0.0.2 2 0 4"* ]]
  [[ ${lines[17]} == *"A blacklist-blocked.test.pi-hole.net 127.0.0.3 3 2 4"* ]]
  [[ ${lines[18]} == *"A regex1.test.pi-hole.net 127.0.0.3 3 2 4"* ]]
  [[ ${lines[19]} == *"A discourse.pi-hole.net 127.0.0.3 3 2 4"* ]]
  [[ ${lines[20]} == *"TXT version.bind 127.0.0.4 3 2 6"* ]]
  [[ ${lines[21]} == *"TXT version.bind 127.0.0.5 3 2 6"* ]]
  [[ ${lines[22]} == *"TXT version.bind 127.0.0.6 3 2 6"* ]]
  ...
  [[ ${lines[28]} == *"ANY any.dns.netmeister.org 127.0.0.1 2 0 13"* ]]
